...
export default {
    ...
    methods: {
        ...
        Oncost_typeChange(data) {
            ...
            this.M_MKQuotationCosting.cost_typeLabel = data.cost_type
        ...
        doSave() {
            this.$validator._base.validateAll("MK_FormMKQuotationCosting").then(result => {
                if (!result) return;
        ...
        M_Save() {
            var param = {
                ...
                mk_quotation_price_id: this.paramFromList.ForCosting.mk_quotation_price_id,
