<template>
    <div>
        ...
        <!-- <ABSModal id="modalEdit" ref="modalEdit" size="md" :okCancel="isCanEdit" :okOnly="!isCanEdit" @modalOkClicked="modalOk" @modalCancelClicked="modalCancel">
            ...
            <b-row>
              <b-col sm="12">
                <div class="modal-customize-abs__modal-header"> 
                  <div style="width:50%;" class="modal-customize-abs__modal-header--title">Log Book Detail</div>
                  <div
                ...
                <div class="modal-customize-abs__modal-body">
                  ...
                  <b-row align-h="between">
                    <b-col cols="3">
                      <b-button  size="sm" variant="outline-primary">Add</b-button>
                    </b-col>
                    <b-col cols="3">
                      <b-button
                        size="sm"
