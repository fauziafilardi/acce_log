                ...
                <b-row>
                    ...
                    <b-col md="2">
                        <b-row>
                            ...
                            <b-col>
                                <!-- <ACCDropDown v-if="inputStatus !== 'edit'"
                                  @change="dofilterActionM"
                                  :prop="PI_customer"
                                  v-model="M_Target.cm_contact_id"
                                  :label="M_Target.customer_name"
                                  ref="ref_action"
                                /> -->
                                <b-form-select v-if="inputStatus !== 'edit'"
                                    id="cmbMarketing"
...
export default {
  data() {
    return {
      ...
      PI_customer: {
        ...
        cDisplayColumn: "name",
        cInputStatus: "new",
        cStyle: "height: 22px !important; width: 100% !important; margin-bottom: 5px;",
      },
  ...
  methods: {
    ...
    getCustomer() {
        var param = {
            option_function_cd: "GetCMContact",
            module_cd: "CM"
        };
        ...
        this.CallFunction(param).then(response => {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                this.cmbMarketing.push({value: data[i].cm_contact_id, text: data[i].customer_name});
            }
        })
    },
    renderTable() {
    ...
    M_Save() {
        var paramDelete = {
            ...
            _LineNo_: 0,
            ss_portfolio_id: this.getDataUser().portfolio_id,
            cm_contact_id: this.filterActionM,
