                      ...
                      <b-col style="max-width: fit-content !important;">
                        <b-row>
                          ...
                          >
                            <span
                              style="color: #666666;"
                            >{{ M_Target[index].target + " " + M_Target[index].satuan }}</span>
                          </b-col>
                        </b-row>
                        <b-row>
                          <b-col style="max-width:fit-content !important;">
                          ...
                          >
                            <span
                              style="color: #666666;"
                            >{{ M_Target[index].achievement + " " + M_Target[index].satuan }}</span>
                          </b-col>
                        </b-row>
                      </b-col>
...
export default {
  ...
  methods: {
    ...
    renderChart() {
      var param = {
        option_function_cd: "GetMarketingTargetDashDt",
        module_cd: "MK",
        user_id: this.getDataUser().user_id,
      ...
      this.CallFunction(param).then((response) => {
        ...
        for (let i = 0; i < this.M_Marketing.length; i++) {
          var dt = response.Data,
            is = this,
            data = dt.filter((x) => {
              return x.marketing_id == is.M_Marketing[i].marketing_id;
            }),
          ...
          console.log(data);
          this.M_Target[i].satuan = data[0].display_satuan;
          this.M_Target[i].target = Math.round(sumtg)
            .toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
          this.M_Target[i].achievement = Math.round(sumac)
            .toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, ",");
          this.M_Target[i].avg = Math.round((sumac / sumtg) * 100);
          ...
          var ctx = document.getElementById("bar-chart" + i).getContext("2d");
