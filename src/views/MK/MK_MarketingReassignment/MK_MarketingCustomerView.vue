...
export default {
  ...
  methods: {
    Onmarketing_idChange(data) {
      this.$nextTick(() => {
        this.M_Customer.marketing_id = data.id;
        this.M_Customer.marketing_idLabel = data.descs;
      });
    },
    ...
    M_Save() {
      var param = {
        ...
        old_marketing_id: this.paramFromList.marketing_id,
        marketing_id: this.M_Customer.marketing_id,
        lastupdatestamp: this.paramFromList.lastupdatestamp,
        user_edit: this.getDataUser().user_id
      };
