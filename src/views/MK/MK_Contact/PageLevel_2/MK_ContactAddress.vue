...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_CM_ContactAddress.contactid = data.contact_id
        ...
        M_Insert() {
          console.log(this.M_CM_ContactAddress);
            var param = {			
                OptionSeq: this.getOptionSeq().OptionSeq,
                LineNo: this.$parent.data.page_order,
                contact_id: this.M_CM_ContactAddress.contactid,
                cm_contact_id: this.M_CM_ContactAddress.cmcontactid,
                address_cd: this.M_CM_ContactAddress.addresscd,
                billing_status: this.M_CM_ContactAddress.addresscategory.indexOf('B') >= 0 ? 'Y' : 'N',
                mailing_status: this.M_CM_ContactAddress.addresscategory.indexOf('M') >= 0 ? 'Y' : 'N',
                tax_status: this.M_CM_ContactAddress.addresscategory.indexOf('T') >= 0 ? 'Y' : 'N',
                address_type: this.M_CM_ContactAddress.addresstype,
                salutation_cd: this.M_CM_ContactAddress.salutationcd == '' || this.M_CM_ContactAddress.salutationcd == null ? 'NULL' : this.M_CM_ContactAddress.salutationcd ,
                ...
                city_cd: this.M_CM_ContactAddress.citycd == '' || this.M_CM_ContactAddress.citycd == null ? 'NULL' : this.M_CM_ContactAddress.citycd ,
                post_cd: this.M_CM_ContactAddress.zipcode,
                phone_no: this.M_CM_ContactAddress.phoneno,
                fax_no: this.M_CM_ContactAddress.faxno,
                remarks: this.M_CM_ContactAddress.remarks,
                user_input: this.getDataUser().user_id ,
                debtor_cd: this.M_CM_ContactAddress.debtorcd,
                id_no: this.M_CM_ContactAddress.idno,
                passport_no: this.M_CM_ContactAddress.passportno                
            }
        ...
        M_Update() {
            var param = {			
                ...
                // address_cd: this.M_CM_ContactAddress.addresscd,
                cm_contact_id: this.M_CM_ContactAddress.cmcontactid,
                cm_contact_address_id: this.M_CM_ContactAddress.cmcontactaddressid,
                billing_status: this.M_CM_ContactAddress.addresscategory.indexOf('B') >= 0 ? 'Y' : 'N',
                mailing_status: this.M_CM_ContactAddress.addresscategory.indexOf('M') >= 0 ? 'Y' : 'N',
                tax_status: this.M_CM_ContactAddress.addresscategory.indexOf('T') >= 0 ? 'Y' : 'N',
                address_type: this.M_CM_ContactAddress.addresstype,
                ...
                debtor_cd: this.M_CM_ContactAddress.debtorcd,
                rental_billing_status: this.M_CM_ContactAddress.billingstatus,
                service_charge_status: this.M_CM_ContactAddress.servicechargestatus,
                meter_utility_status: this.M_CM_ContactAddress.meterutilitystatus,
                id_no: this.M_CM_ContactAddress.idno,
                passport_no: this.M_CM_ContactAddress.passportno                
            }
        ...
        M_New(){
            let data = this.$store.getters.GetPage1Data
            this.M_CM_ContactAddress.contactid = data.contact_id
            this.M_CM_ContactAddress.cmcontactid = data.cm_contact_id
        ...
        data.forEach((value) => {
          ...
          cm_contact_address_id: value.cm_contact_address_id,
        ...
        getDataBy (record) {
            var param = {
                ...
                cm_contact_address_id: record.cm_contact_address_id,
...
this.M_CM_ContactAddress = {
                ...
                cmcontactaddressid: data.cm_contact_address_id,
                ...
                this.M_CM_ContactAddress.salutationcdLabel = this.M_CM_ContactAddress.salutationcd != null ? data.salutation_cd + this.separator + data.salutation_descs :'' 
                this.M_CM_ContactAddress.citycdLabel = this.M_CM_ContactAddress.citycd != null ? data.city_cd + this.separator + data.city_descs :'' 
