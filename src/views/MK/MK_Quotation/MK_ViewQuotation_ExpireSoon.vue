                    ...
                    <b-row>
                      <b-col>
                        <ABSButton
                          v-show="is_hide_button"
                          :disabled="!isShow"
                          :text="AllData.status == 'P' ? 'Confirm' : 'Proposed'"
                          classButton="btn btn--default"
                          classIcon="icon-style-1"
                          size="6x"
                          @click="doConfirm"
    ...
    <ABSModal id="Modal_MK_Quotation" ref="Modal_MK_Quotation" size="sm">
      ...
      <template slot="content">
        <b-row>
          <b-col md="12">
            <b-form
              :data-vv-scope="'CancelQuotation'"
              :data-vv-value-path="'CancelQuotation'"
            >
              <b-row>
                <b-col md="12">
                  <b-row>
                    <b-col md="12">
                      ...
                      <ACCLookUp
                        ...
                        :prop="PI_reason_cd"
                        v-model="M_CancelQuotation.reason_cd"
                        :label="M_CancelQuotation.reason_cdLabel"
                        ref="ref_reason_cd"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      ...
                      <ACCTextArea
                        ...
                        v-model="M_CancelQuotation.reason_descs"
  ...
  methods: {
    ...
    doCancelQuot() {
        var param = {
            ...
            reason_cd: this.M_CancelQuotation.reason_cd,
            reason_descs: this.M_CancelQuotation.reason_descs,
            lastupdatestamp: this.paramFromList.lastupdatestamp,
    ...
    OnReasonChange(data) {
      this.$nextTick(() => {
        this.M_CancelQuotation.reason_cd = data.reason_cd;
        this.M_CancelQuotation.reason_cdLabel = data.label;
        this.M_CancelQuotation.reason_descs = data.descs;
      });
    },
    ...
    doConfirm() {
      ...
      this.postJSON(this.getUrlCRUD(), param).then(response => {
        // response from API
        if (response == null) return;
        this.alertSuccess(this.AllData.status == 'P' ? "Confirmation Success" : "Proposed Success").then(() => {
          this.doBack();
        });
      });
    },
