...
//{remarks}
		...
		paramFromParent(){
            ...
            this.propList.initialWhere ="SubPortfolioCd='"+this.getDataUser().subportfolio_cd+"' AND SalesAnalysisCategory = '" + data.SalesAnalysisCategory + "' "
...
this.M_SM_SalesAnalysisDetail = {
                ...
                sm_salesanalysisd_id: record.row_id,
