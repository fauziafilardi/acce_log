                ...
                <b-row>
                  <b-col md="2">
                    <div>
                      <div style="text-align: center;">
                        <font-awesome-icon class="icon-style-default" icon="wrench" size="10x" />
                      </div>
                    </div>
                  </b-col>
                  <b-col md="10" class="row-bordered">
                    ...
                    <b-col md="6" offset="3">
                        ...
                        <b-col>
                          <b-row>
                            <b-col>
                              ...
                              <ACCTextBox
                                :prop="PI_last_maint_usage"
                                v-model="M_FmFleetMstr.last_maint_usage"
                                ref="ref_last_maint_usage"
                              />
                            </b-col>
                            <b-col style="max-width: fit-content !important; margin-top: 35px;">Km</b-col>
                          </b-row>
                        </b-col>
                        <b-col>
                          <b-row>
                            <b-col>
                              ...
                              <ACCDateTime
                                @input="Onlast_maint_dateChange"
                                :prop="PI_last_maint_date"
                                v-model="M_FmFleetMstr.last_maint_date"
                                ref="ref_last_maint_date"
                              />
                            </b-col>
                          </b-row>
                        </b-col>
                      ...
                      <b-row v-show="M_FmFleetMstr.triggerby=='U'" class="row-bordered">
                        <b-col>
                          <b-row>
                            <b-col>
                              <span>
                                <label>Triger By Usage</label>
                              </span>
                              <!-- <ACCRadioButton
                      ...
                      <!-- by time -->
                      <b-row v-show="M_FmFleetMstr.triggerby=='T'" class="row-bordered">
                        <b-col>
                          <b-row>
                            <b-col>
                              <span>
                                <label>Triger By Time</label>
                              </span>
                              <!-- <ACCRadioButton
  ...
  methods: {
    ...
    doSave() {
      this.$validator._base
        .validateAll("OP_FormFmFleetMstrMaintenance")
        .then(result => {
          if (!result) return;
    ...
    M_Save() {
      ...
      var param = {
        ...
        time_days:
          this.M_FmFleetMstr.triggerby == "U"
            ? this.M_FmFleetMstr.time
            : this.M_FmFleetMstr.time_time,
        time_days_tolerance:
          this.M_FmFleetMstr.triggerby == "U"
            ...
            : this.M_FmFleetMstr.time_time_t,
        last_maint_usage:
          this.M_FmFleetMstr.last_maint_usage &&
          this.M_FmFleetMstr.last_maint_usage !== ""
            ? this.M_FmFleetMstr.last_maint_usage
            : "NULL",
        last_maint_date:
          this.M_FmFleetMstr.last_maint_date &&
          this.M_FmFleetMstr.last_maint_date !== ""
            ? this.M_FmFleetMstr.last_maint_date
            : "NULL",
    ...
    GetDataBy() {
      ...
      this.getJSON(this.getUrlCRUD(), param).then(response => {
        ...
        this.M_FmFleetMstr = {
          ...
          usage_t:
            data.trigger_by == "U" ? data.usage_tolerance_distance__tb_4 : "",
          ...
          time_time_t:
            data.trigger_by == "T" ? data.time_days_tolerance__tb_6 : "",
          triggerby: data.trigger_by,
          last_maint_usage:
            data.last_maint_usage && data.last_maint_usage !== ""
              ? data.last_maint_usage
              : "NULL",
          last_maint_date:
            data.last_maint_date && data.last_maint_date !== ""
              ? data.last_maint_date
              : "NULL"
        };
      });
    }
    // CheckType() {
    //   if (
    //     this.paramFromList.ForMaintenance == null ||
    //     this.paramFromList.ForMaintenance == undefined
    //   ) {
    //     this.Stype = "M";
    //   } else {
    //     if (Object.keys(this.paramFromList.ForMaintenance).length < 0) {
    //       this.Stype = "M";
    //     } else {
    //       this.Stype = "D";
    //     }
