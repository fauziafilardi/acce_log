        ...
        <b-col md="12">
          <div class="card" style="font-size: 12px !important;">
            ...
            <div class="card__body">
              <b-form :data-vv-scope="'OP_FormCmZone'" :data-vv-value-path="'OP_FormCmZone'">
                <b-row>
                  <b-col md="2">
                    <div>
  ...
  methods: {
    ...
    M_Update() {
      var param = {
        option_url: "/OP/OP_Zone",
        line_no: 0,
        cm_zone_id: this.M_CmZone.cm_zone_id,
        ss_portfolio_id: this.getDataUser().portfolio_id,
        zone_cd: this.M_CmZone.zone_cd,
        descs: this.M_CmZone.descs,
      ...
      this.putJSON(this.getUrlCRUD(), param).then(response => {
        ...
        this.alertSuccess(response.Message).then(() => {
          if (this.inputStatus == "new") {
            ...
            this.$router.replace({ name: "OP_Zone" });
          }
        });
      });
    },
