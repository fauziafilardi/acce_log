                  ...
                  <b-col md="10">                                                       
                    <b-row class="row-view">
                      <b-col>
                        ...
                        <br/>
                        <span>
                          <label>{{M_OpVendorGps.vendor_name}}</label>
                        </span>
                      </b-col>
                      <b-col style = "text-align: right;" >
                        <span>
                    ...
                    <b-row class="row-view">
                      <b-col>
                        ...
                        <br/>
                        <span>
                          <label>{{M_OpVendorGps.phone_no}}</label>
                        </span>
                      </b-col>
                    </b-row>
                    <b-row class="row-view">
                      <b-col>
                        ...
                        <br/>
                        <span>
                          <label>{{M_OpVendorGps.descs}}</label>
                        </span>
                      </b-col>
                    </b-row>
...
export default {
  ...
  methods: {
    ...
    doEdit() {
      ...
      this.$router.push({ name: "OP_VendorGpsForm", params: param });
    },
	doDelete(){
