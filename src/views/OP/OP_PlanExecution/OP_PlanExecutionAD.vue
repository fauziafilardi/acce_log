              ...
              <b-form :data-vv-scope="'OP_SL_PlanExecution'" :data-vv-value-path="'OP_SL_PlanExecution'">
                <b-row>
                  ...
                  <b-col md="10">
                        ...
                        <div class="container-step">
                          <ul class="progressbar" style="padding-inline-start: 0px !important;">
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              ...
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.order_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Assign</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.assign_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Dispatch</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.dispatch_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Arrived</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.arrival_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Start Loading</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.start_loading_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Finish Loading</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.finish_loading_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Get Out</span>
                              <br />
                              <span style="top: -20px; position: relative;">{{M_AD_Plan.get_out_arrival_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important; margin-top: 15px;">
                              <span style="top: -75px; position: relative; font-weight: bold;">Arrive Destination</span>
                              <br />
                              <span style="top: -36px; position: relative;">{{M_AD_Plan.arrival_destination_date}}</span>
                            </li>
                      ...
                      <b-col md="9" style="padding-left: 0px !important;">
                        ...
                        >
                          ...
                          >
                            <span>Category</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_AD_Plan.category_descs}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                      ...
                      <b-col md="6" style="padding-left: 0px !important;">
                        ...
                        <b-row class="row-view">
                            <b-col md="12" style="padding-left: 0px !important;">
                                ...
                                <br>
                                <span>
                                  <label>{{M_AD_Plan.loading_comodity}}</label>
                                </span>
                            </b-col>
                        </b-row>
                        <b-row class="row-view">
                            <b-col md="4" style="padding-left: 0px !important;">
                                ...
                                <br>
                                <span>
                                  <label>{{M_AD_Plan.loading_total_item}}</label>
                                </span>
                            </b-col>
                            <b-col md="4" style="padding-left: 0px !important;">
                                <span>
                                ...
                                <br>
                                <span>
                                  <label>{{M_AD_Plan.loading_kgs}}</label>
                                </span>
                            </b-col>
                            <b-col md="4" style="padding-left: 0px !important;">
                                <span>
                                ...
                                <br>
                                <span>
                                  <label>{{M_AD_Plan.loading_cbm}}</label>
                                </span>
                            </b-col>
                        </b-row>
                        <b-row>
                    ...
                    <b-row class="row-bordered" style="margin-top: 10px;" v-show="M_AD_Plan.category == 'C'">
                      <b-col md="12">
                        <b-row>
                          <b-col style="max-width: fit-content !important;">
  ...
  methods: {
    ...
    M_Update() {
      var paramH = {
        ...
        start_unloading_date: this.M_PlanExe.start_unloading && this.M_PlanExe.start_unloading !== '' ? this.M_PlanExe.start_unloading : "NULL", // DARI FORM
        start_unloading_notes: this.M_PlanExe.note, // DARI FORM
