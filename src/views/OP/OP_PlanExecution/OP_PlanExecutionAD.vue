                        ...
                        <div class="container-step">
                          <ul class="progressbar" style="padding-inline-start: 0px !important;">
                            <li class="active" style="width: 10% !important;">
                                <span>Order</span>
                                <br />
                                <span>{{this.M_AD_Plan.order_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Assign</span>
                                <br />
                                <span>{{this.M_AD_Plan.assign_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Dispatch</span>
                                <br />
                                <span>{{this.M_AD_Plan.dispatch_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Arrived</span>
                                <br />
                                <span>{{this.M_AD_Plan.arrival_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Start Loading</span>
                                <br />
                                <span>{{this.M_AD_Plan.start_loading_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Finish Loading</span>
                                <br />
                                <span>{{this.M_AD_Plan.finish_loading_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Get Out</span>
                                <br />
                                <span>{{this.M_AD_Plan.get_out_arrival_date}}</span>
                            </li>
                            <li class="active" style="width: 10% !important;">
                                <span>Arrive Destination</span>
                                <br />
                                <span>{{this.M_AD_Plan.get_out_destination_date}}</span>
                            </li>
                            <li style="width: 10% !important;">
                                <span>Start Unloading</span>
                                <br />
                                <span>{{this.M_AD_Plan.start_unloading_date}}</span>
                            </li>
                            <li style="width: 10% !important;">
                                <span>Finish Unloading</span>
                                <br />
                                <span>{{this.M_AD_Plan.finish_unloading_date}}</span>
                            </li>
                          </ul>
                        </div>
                      </b-col>
