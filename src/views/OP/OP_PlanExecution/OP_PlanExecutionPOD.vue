                      ...
                      <b-col md="9" style="padding-left: 0px !important;">
                        ...
                        >
                          ...
                          >
                            ...
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.order_no}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                            <span>Date</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.date}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                            <span>Category</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.category_descs}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                            <span>From</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.from}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                            <span>To</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.to}}</span>
                          </b-col>
                        </b-row>
                        <b-row style="border: solid 1px #e7eaec;border-radius: 0px 0px 5px 5px;">
                          ...
                          >
                            ...
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.pickup_date}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                            <span>KGS</span>
                            <br />
                            <span style="color: rgb(153 153 153)">{{M_POD_Plan.kgs}}</span>
                          </b-col>
                          <b-col
                            style="border-right: solid 1px #e7eaec; padding: 10px !important; max-width: 20% !important;"
                          >
                      ...
                      <b-col md="3">
                        ...
                        >
                          ...
                          <b-col style="margin: auto;">
                            ...
                            <br />
                            <span class="AppointmentDescs">{{M_POD_Plan.driver1}}</span>
                          </b-col>
                        </b-row>
                      </b-col>
                    </b-row>
                          ...
                          <b-col md="12" style="padding-left: 0px !important;">
                            <b-list-group>
                              <b-list-group-item>
                                <span>From :</span>
                                <br />
                                <span style="color: rgb(153 153 153)">{{M_POD_Plan.from_address}}</span>
                              </b-list-group-item>
                              <b-list-group-item>
                                <span>To :</span>
                                <br />
                                <span style="color: rgb(153 153 153)">{{M_POD_Plan.to_address}}</span>
                              </b-list-group-item>
                            </b-list-group>
                          </b-col>
                        </b-row>
