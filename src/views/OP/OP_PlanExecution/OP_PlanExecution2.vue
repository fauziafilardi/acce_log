          ...
          <div>
            ...
            >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span>{{PlanExecution[data.key]}}</span>
                            </div>
                            <div
                              class="Plan-Dot-Text"
              ...
              <template slot="status" slot-scope="data">
                <div :class="'Plan-Dot-' + (Status[data.item.status].variant)" :style="data.item.status !== 'POD' ? 'font-size: 10px !important; padding-top: 9px !important;' : 'font-size: 9px !important; padding-top: 9px !important;'">{{data.item.status}}</div>
              </template>
            </ACCList2>
          </div>
        </b-col>
...
export default {
  ...
  methods: {
    ...
    onRenderData(data) {
        var param = {
            option_function_cd: "GetOrderQty",
            module_cd: "OP",
        ...
        .then(ress => {
            ...
            for (let x = 0; x < data.length; x++) {
                this.PlanExecution[data[x].order_status] = parseInt(data[x].total)
                all += parseInt(data[x].total)
            }

            this.PlanExecution.All = all
        })
    },
  },
  mounted() {
