                    ...
                    <b-col md="6" offset="3" v-else-if="Stype == 'D'">
                      ...
                      <b-row>
                        <b-col>
                          ...
                          <ACCTextBox :prop="PI_qty" v-model="M_FmFleetMstr.qty" ref="ref_qty" />
                        </b-col>
                      </b-row>
                      <b-row style="margin-top: 10px;">
                        <b-col style="text-align: center">
  ...
  methods: {
    ...
    doSave() {
      this.$validator._base
        .validateAll("OP_FormFmFleetMstrMaintenanceItem")
        .then((result) => {
          if (!result) return;
            ...
            (ress) => {
              if (ress.value) {
                this.$validator.errors.clear(
                  "OP_FormFmFleetMstrMaintenanceItem"
                );
    ...
    M_Save() {
      ...
      if (this.Stype == "M") {
        ...
        param = {
          ...
          line_no: 3,
          ss_portfolio_id: this.getDataUser().portfolio_id,
          fm_fleet_mstr_id: this.paramFromList.ForMaintenanceItem
            .fm_fleet_mstr_id,
          fm_fleet_maintenance_type_id: this.paramFromList.ForMaintenanceItem
            .fm_fleet_maintenance_type_id,
        ...
        param = {
          ...
          line_no: 1,
          ss_portfolio_id: this.getDataUser().portfolio_id,
          mm_maintenance_type_id: this.paramFromList.ForMaintenanceItem
            .mm_maintenance_type_id,
          mm_maintenance_item_id: this.M_FmFleetMstr.item,
          item_qty: this.M_FmFleetMstr.qty,
          user_input: this.getDataUser().user_id,
        };
    ...
    M_Update() {
      ...
      if (this.Stype == "M") {
        ...
        param = {
          option_url: "/OP/OP_FleetMaster",
          line_no: 3,
          fm_fleet_maintenance_item_id: this.paramFromList.ForMaintenanceItem
            .row_id,
          mm_maintenance_item_id: this.paramFromList.ForMaintenanceItem
            .mm_maintenance_item_id,
          ss_portfolio_id: this.getDataUser().portfolio_id,
          fm_fleet_mstr_id: this.paramFromList.ForMaintenanceItem
            .fm_fleet_mstr_id,
          fm_fleet_maintenance_type_id: this.paramFromList.ForMaintenanceItem
          ...
          item_qty: this.M_FmFleetMstr.qty,
          lastupdatestamp: this.paramFromList.ForMaintenanceItem
            .lastupdatestamp,
          user_edit: this.getDataUser().user_id,
        };
      } else {
        param = {
          option_url: "/OP/OP_MaintenanceType",
          line_no: 1,
          mm_maintenance_type_dtl_id: this.paramFromList.ForMaintenanceItem
            .row_id,
          mm_maintenance_type_id: this.paramFromList.ForMaintenanceItem
            .mm_maintenance_type_id,
          mm_maintenance_item_id: this.paramFromList.ForMaintenanceItem
    ...
    CheckType() {
      if (
        this.paramFromList.ForMaintenanceItem == null ||
        this.paramFromList.ForMaintenanceItem == undefined
      ) {
        this.Stype = "M";
      } else {
