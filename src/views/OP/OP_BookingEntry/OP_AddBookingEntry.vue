                      ...
                      <b-col md="12">
                        ...
                        <b-row>
                          <b-col>
                            ...
                            <ACCTextArea :prop="PI_descs" v-model="M_Order.descs" ref="ref_descs" />
                          </b-col>
                        </b-row>
                      </b-col>
                    </b-row>
                      ...
                      <b-col md="12">
                        <b-row>
                          ...
                          <b-col class="col-right" md="1">
                            <div
                              style="width: 60px; text-align: center; border-radius: 5px !important;"
                              class="row-bordered"
                            >
                              <span
                                style="font-size: 13px; color: #333399; font-weight: bold;"
                              >{{M_Order.category == "F" ? "FTL" : (M_Order.category == "L" ? "LTL" : "Project")}}</span>
                            </div>
                          </b-col>
                        </b-row>
                        <b-row v-show="inputStatus == 'new'">
                          <b-col>
                            <div
                              @click="OnTLChange('FTL')"
                              :class="M_Order.TL == 'FTL' ? 'isOn' : 'isOff'"
                            >FTL</div>
                          </b-col>
                          <b-col>
                            <div
                              @click="OnTLChange('LTL')"
                              :class="M_Order.TL == 'LTL' ? 'isOn' : 'isOff'"
                            >LTL</div>
                          </b-col>
                          <b-col>
                            <div
                              @click="OnTLChange('P')"
                              :class="M_Order.TL == 'P' ? 'isOn' : 'isOff'"
                            >Project</div>
                          </b-col>
                        </b-row>
                        <br />
                        ...
                        <b-row v-show="M_Order.TL == 'LTL'">
                          ...
                          <b-col>
                            ...
                            <ACCTextBox :prop="PI_kgs" v-model="M_Order.kgs" ref="ref_kgs" />
                          </b-col>
                          <b-col>
                            <span>
                              <label>CBM</label>
                            </span>
                            <ACCTextBox :prop="PI_cbm" v-model="M_Order.cbm" ref="ref_cbm" />
                          </b-col>
                        </b-row>
                        ...
                        <b-row
                          v-for="(data,index) in FTL"
                          v-bind:key="index"
                          v-show="M_Order.TL !== 'LTL'"
                        >
                          <b-col>
                            <span>
                              <label>Truck</label>
      ...
      PI_pickup_from: {
        dataLookUp: {
          ...
          InitialWhere:
            ...
            "' AND cm_contact_id=0 AND category='F'",
          ParamWhere: "",
          OrderBy: "",
          ParamView: "",
          SourceField: "",
      ...
      PI_deliver_to: {
        dataLookUp: {
          ...
          InitialWhere:
            "ss_portfolio_id='" +
            this.getDataUser().portfolio_id +
            "' AND cm_contact_id=0 AND category='F' AND fr_cm_contact_delivery_address_id=0",
          ParamWhere: "",
          OrderBy: "",
          ParamView: "",
          SourceField: "",
      ...
      PI_comodity: {
        dataLookUp: {
          ...
          InitialWhere:
            "ss_portfolio_id='" +
            this.getDataUser().portfolio_id +
            "' AND cm_contact_id=0 AND category='L'",
          ParamWhere: "",
          OrderBy: "",
          ParamView: "",
          SourceField: "",
      ...
      PI_contract_no: {
        dataLookUp: {
          ...
          InitialWhere:
            "ss_portfolio_id='" +
            this.getDataUser().portfolio_id +
            "' AND cm_contact_id=0 AND category='P'",
          ParamWhere: "",
          OrderBy: "",
          ParamView: "",
          SourceField: "",
  ...
  methods: {
    ...
    OncustomerChange(data) {
      ...
      this.$nextTick(() => {
        ...
        this.PI_pickup_from.dataLookUp.InitialWhere =
          "ss_portfolio_id='" +
          this.getDataUser().portfolio_id +
          "' AND cm_contact_id=" +
          data.id +
          ...
          (this.M_Order.TL == "FTL"
            ...
            ? "'L'"
            : "'P'");
        this.PI_comodity.dataLookUp.InitialWhere =
          "ss_portfolio_id='" +
          this.getDataUser().portfolio_id +
          "' AND cm_contact_id=" +
          data.id +
          " AND category='L'";
        this.PI_contract_no.dataLookUp.InitialWhere =
          "ss_portfolio_id='" +
          this.getDataUser().portfolio_id +
          "' AND cm_contact_id=" +
          data.id +
        ...
        for (let i = 0; i < this.FTL.length; i++) {
          this.FTL[i].PI_truck.dataLookUp.InitialWhere =
            "ss_portfolio_id='" +
            this.getDataUser().portfolio_id +
            "' AND cm_contact_id=" +
            data.id +
    ...
    Onpickup_fromChange(data) {
      ...
      this.$nextTick(() => {
        ...
        this.PI_deliver_to.dataLookUp.InitialWhere =
          "ss_portfolio_id='" +
          this.getDataUser().portfolio_id +
          "' AND cm_contact_id=" +
          (this.M_Order.customer && this.M_Order.customer !== ""
            ? this.M_Order.customer
            : 0) +
          " AND category=" +
          (this.M_Order.TL == "FTL"
            ? "'F'"
            ...
            ? "'L'"
            : "'P'") +
          " AND fr_cm_contact_delivery_address_id='" +
          data.id +
          "'";
      });
    },
    ...
    OnTLChange(data) {
      ...
      this.PI_deliver_to.dataLookUp.InitialWhere =
        ...
        " AND category=" +
        (data == "FTL" ? "'F'" : data == "LTL" ? "'L'" : "'P'") +
        " AND fr_cm_contact_delivery_address_id=0";
      var w = "";
      if (data == "P") {
    ...
    Oncontract_noChange(data) {
      ...
      this.$nextTick(() => {
        ...
        this.M_Order.contracted_volume = this.isCurrency(
          data.contracted_volume,
          this.decimal
        );
        this.M_Order.executed_volume = this.isCurrency(
    ...
    M_Save() {
      var paramH = {
        ...
        booking_status: "P",
        category:
          this.M_Order.TL == "FTL" ? "F" : this.M_Order.TL == "LTL" ? "L" : "P",
        ...
        cm_commodity_id:
          this.M_Order.TL == "LTL"
            ? this.M_Order.comodity && this.M_Order.comodity !== ""
              ? this.M_Order.comodity
              : "NULL"
            : "NULL",
        total_item:
          this.M_Order.TL == "LTL"
            ? this.M_Order.total_item && this.M_Order.total_item !== ""
              ? this.M_Order.total_item
              : 0
            : "NULL",
        total_kgs:
          this.M_Order.TL == "LTL"
            ? this.M_Order.kgs && this.M_Order.kgs !== ""
              ? this.M_Order.kgs
              : 0
            : "NULL",
        total_cbm:
          this.M_Order.TL == "LTL"
            ? this.M_Order.cbm && this.M_Order.cbm !== ""
              ? this.M_Order.cbm
              : 0
            : "NULL",
        mk_quotation_id:
          this.M_Order.TL == "P" ? this.M_Order.mk_quotation_id : "NULL",
      ...
      this.postJSONMulti(this.getUrlProsesDataPostMulti(), params).then(
        (response) => {
    ...
    GetDataBy() {
      ...
      this.getJSON(this.getUrlCRUD(), param).then((response) => {
        ...
        if (data.cm_contact_id__lo_1 && data.cm_contact_id__lo_1 !== "") {
          this.PI_pic.dataLookUp.InitialWhere =
            "cm_contact_id=" + data.cm_contact_id__lo_1;
          this.PI_pickup_from.dataLookUp.InitialWhere =
            "ss_portfolio_id='" +
            this.getDataUser().portfolio_id +
            "' AND cm_contact_id=" +
            data.cm_contact_id__lo_1 +
            " AND category='" +
            data.category +
            "'";
          this.PI_comodity.dataLookUp.InitialWhere =
          ...
          this.PI_deliver_to.dataLookUp.InitialWhere =
            ...
            data.category +
            "' AND fr_cm_contact_delivery_address_id='" +
            data.fr_cm_contact_delivery_address_id__lo_4 +
            "'";
        }
        ...
        this.M_Order = {
          ...
          total_item:
            data.total_item && data.total_item !== ""
              ? this.isCurrency(data.total_item, 0)
              : 0,
          kgs:
            data.total_kgs && data.total_kgs !== ""
              ? this.isCurrency(data.total_kgs, 0)
              : 0,
          cbm:
            data.total_cbm && data.total_cbm !== ""
              ? this.isCurrency(data.total_cbm, 0)
              : 0,
          ...
          contracted_volume:
            data.contract_volume && data.contract_volume !== ""
              ? this.isCurrency(data.contract_volume, 0)
              : 0,
          executed_volume:
            data.contract_executed_volume &&
            data.contract_executed_volume !== ""
              ? this.isCurrency(data.contract_executed_volume, 0)
              : 0,
