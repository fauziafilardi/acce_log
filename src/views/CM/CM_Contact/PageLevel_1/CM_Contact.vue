...
export default {
    ...
    data() {
        ...
        Module:"CM",
        ValKey:null,
        cInsertKey:'id=cm_contact_id,label=contact_id+|+name',
       propList: {
                initialWhere:"",
...
//{taxregistrationdate}
        ...
        OncontactstatusChange (data) {
          this.M_CM_Contact.contactstatus = data.id
        ...
        M_Insert() {
          if (this.ContactRunningCd != "") { 
              var param = {
                  ...
                  running_id: this.ContactRunningCd,
              ...
              .then(ress => {
                ...
                var data = ress.Data[0]
                if (ress != null){                  
                  this.M_CM_Contact.contactid = data._generate_running_code_id
                    var param = {			
                        ...
                        mk_contact_status_h_id: this.M_CM_Contact.contactstatus == '' || this.M_CM_Contact.contactstatus == null ? 'NULL' : this.M_CM_Contact.contactstatus              
                    }
        ...
        M_New(){
          ...
          this.FnDynamicFunction(param)
            .then(ress => {
              ...
              console.log(data)
              if (ress != null){
                this.ContactRunningCd = data.contact_running_id
                if(this.ContactRunningCd != ""){
