						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left">
                                    <b-row>
                                      <b-col md="6">                                       
                                        <ABSinputDateRangeVuex :prop="PI_PeriodDate" :valueFrom="M_CM_CurrencyMasterrate.start_date" :valueTo="M_CM_CurrencyMasterrate.end_date" ref="ref_PeriodDate" @from="start_date" @to="end_date" />
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSinputTextVuex :prop="PI_reference_no" v-model="M_CM_CurrencyMasterrate.reference_no"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSinputDateVuex :prop="PI_reference_date" v-model="M_CM_CurrencyMasterrate.reference_date"/>
                                      </b-col>
                                    </b-row>
                                </b-col>                 
							</b-row>
    ...
    methods: {
        ...
        M_Insert () {
            ...
            var param = {			
                ...
                LineNo: this.$parent.data.page_order,
                currency_cd: this.M_CM_CurrencyMasterrate.currency_cd,
                cm_currency_master_id: this.$store.getters.GetPage1Data.row_id,
                start_date: this.M_CM_CurrencyMasterrate.start_date,
                end_date: this.M_CM_CurrencyMasterrate.end_date,
                rate: this.M_CM_CurrencyMasterrate.rate ? this.replaceAllString(this.M_CM_CurrencyMasterrate.rate, ",", "",'number') : 0 ,
                ref_date: this.M_CM_CurrencyMasterrate.reference_date == '' ? 'NULL' : this.M_CM_CurrencyMasterrate.reference_date,
                ref_no: this.M_CM_CurrencyMasterrate.reference_no,
        ...
        M_New(){
            ...
            this.M_CM_CurrencyMasterrate.currency_cd = data.currency_cd 
        ...
        start_date (data) {
            this.M_CM_CurrencyMasterrate.start_date = data
        },
        end_date (data) {
            this.M_CM_CurrencyMasterrate.end_date = data
        },
    },
    created: function() {
    },
