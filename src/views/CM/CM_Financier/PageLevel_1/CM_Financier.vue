...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.page_order,
                contact_id: this.M_CM_Financier.contactid == '' || this.M_CM_Financier.contactid == null ? 'NULL' : this.M_CM_Financier.contactid ,
                reference_no: this.M_CM_Financier.referenceno,
                start_date: this.M_CM_Financier.startdate,
                reason_cd: this.M_CM_Financier.reasoncd == '' || this.M_CM_Financier.reasoncd == null ? 'NULL' : this.M_CM_Financier.reasoncd ,
                reason_descs: this.M_CM_Financier.reasondescs,
...
this.M_CM_Financier = {
                ...
                cmreasondescs: data.cm_reason_descs,
                rowid: data.row_id
                    }
                 

                this.M_CM_Financier.contactidLabel = this.M_CM_Financier.contactid != null ? data.contact_id + this.separator + data.contact_name :'' 
                this.M_CM_Financier.reasoncdLabel = this.M_CM_Financier.reasoncd != null ? data.reason_cd + this.separator + data.cm_reason_descs :'' 
