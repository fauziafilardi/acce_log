...
this.M_CM_ContactFamilyRegistration = {
                ...
                this.M_CM_ContactFamilyRegistration.nationalitycdLabel = this.M_CM_ContactFamilyRegistration.nationalitycd != null ? data.nationality_cd + this.separator + data.nationality_descs :'' 
