...
//{remarks}
        ...
        GetValidateCoreBusiness() {
            //GetValidateCoreBusiness
            var param = {
                OptionFunctionCd: 'GetValidateCoreBusiness',
                ModuleCd: 'CM',
                p_contact_id: '',
                p_business_type_cd: this.M_CM_ContactBusinessTypeRegistration.businesstypecd
            }
        ...
        if (this.M_CM_ContactBusinessTypeRegistration.corebusiness == "Y")
             { 
                 this.GetValidateCoreBusiness().then(dt28 =>
                    { if (dt28 != null)  { 
                        console.log(dt28)
                    } 
                })  
