    ...
    methods: {
        ...
        getDataList (search) {
            var param = {
                ...
                sequence_registration_no: this.DataRowPage1.sequence_registration_no,
                LineNo: 7,
                InitialWhere: search && search != '' ? ("address_cd iLIKE '%" + search + "%'") : '',
                ParamView: "'"+this.getDataUser().subportfolio_cd+"', '"+this.DataRowPage1.sequence_registration_no+"'" ,
        ...
        M_Insert() {
            ...
            for (let x = 0 ; x < this.leftDataOptions.length ; x ++) {
                param1.push({
                    ...
                    subportfolio_cd: this.getDataUser().subportfolio_cd,
                    sequence_registration_no: this.DataRow.sequence_registration_no,
