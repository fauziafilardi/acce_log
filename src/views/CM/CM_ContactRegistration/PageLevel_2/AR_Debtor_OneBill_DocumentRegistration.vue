...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                contact_id: this.M_AR_Debtor_OneBill_DocumentRegistration.contactid,
        ...
        M_New(){
            let data = this.$store.getters.GetPage1Data
            this.M_AR_Debtor_OneBill_DocumentRegistration.contactid = data.contact_id 
            this.M_AR_Debtor_OneBill_DocumentRegistration.sequenceregistrationno = data.sequence_registration_no 
...
this.M_AR_Debtor_OneBill_DocumentRegistration = {
                ...
                controlsequenceno: data.control_sequencen_o,
                rowid: data.row_id
                    }
                 

                this.M_AR_Debtor_OneBill_DocumentRegistration.documenttypeLabel = this.M_AR_Debtor_OneBill_DocumentRegistration.documenttype != null ? data.document_type + this.separator + data.descs :'' 
