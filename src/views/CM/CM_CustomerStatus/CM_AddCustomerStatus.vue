            ...
            <div class="card__body">
                      ...
                      <b-col md="6">
                        ...
                        >
                            <template v-slot:cell(action_id)="data">
                                ...
                                >
                                    <font-awesome-icon icon="edit" class="icon-style-default" style="color: white;" />
                                </b-button>
                            </template>
                        </b-table>
                      </b-col>
              ...
              <ABSModal id="Modal_Status" ref="Modal_Status" size="sm">
                    ...
                    <template slot="content">
                        ...
                        <b-col md="12">
                            <b-form
                            :data-vv-scope="'MStatus'"
                            :data-vv-value-path="'MStatus'"
                            >
                            <b-row>
                                <b-col md="12">
                                    <b-row>
...
export default {
  data() {
    return {
      ...
      fieldHeader: [
          { key: "action", label: "Action", tdClass: "ABStdClassList2 notranslate th-cus-center", thClass: "ABStdClassList2 th-cus-center" },
          { key: "month", label: "Month", tdClass: "ABStdClassList2 notranslate th-cus-center", thClass: "ABStdClassList2 th-cus-center" },
          { key: "freq", label: "Frequency", tdClass: "ABStdClassList2 notranslate th-cus-center", thClass: "ABStdClassList2 th-cus-center" },
          { key: "action_id", label: "Edit", tdClass: "ABStdClassList2 notranslate th-cus-center", thClass: "ABStdClassList2 th-cus-center" }
      ],
      M_CustomerStatusDtl: [],
      M_ModalStatus: {
          action: "",
  ...
  methods: {
    ...
    SaveModal() {
        if (this.ModalIndex !== null) {
            this.M_CustomerStatusDtl[this.ModalIndex].action = this.M_ModalStatus.actionLabel
            this.M_CustomerStatusDtl[this.ModalIndex].action_id = this.M_ModalStatus.action
            this.M_CustomerStatusDtl[this.ModalIndex].month = this.M_ModalStatus.month && this.M_ModalStatus.month !== "" ? this.M_ModalStatus.month : 0
            this.M_CustomerStatusDtl[this.ModalIndex].freq = this.M_ModalStatus.freq && this.M_ModalStatus.freq !== "" ? this.M_ModalStatus.freq : 0
        }
        else {
            this.M_CustomerStatusDtl.push({
                action: this.M_ModalStatus.actionLabel,
                action_id: this.M_ModalStatus.action,
                month: this.M_ModalStatus.month && this.M_ModalStatus.month !== "" ? this.M_ModalStatus.month : 0,
                freq: this.M_ModalStatus.freq && this.M_ModalStatus.freq !== "" ? this.M_ModalStatus.freq : 0,
            })
        }
    ...
    GetDataBy() {
      ...
      this.getJSON(this.getUrlCRUD(this.paramFromList.row_id), param).then(response => {
        ...
        response.Data.forEach((dtl, index) => {
            this.M_CustomerStatusDtl.push({
                action_id: dtl.action == "Call" ? "C" : (dtl.action == "Visit" ? "V" : "E"),
                action: dtl.action,
                month: dtl.month,
                freq: dtl.freq
            })
